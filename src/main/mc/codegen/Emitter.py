...
class Emitter():
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) in [ArrayPointerType,ArrayType] or type(in_) is cgen.ClassType or type(in_) is StringType:
    ...
    def emitASTORE(self, in_, frame):
        ...
        elif type(in_) in [ArrayPointerType,ArrayType] or type(in_) is ClassType or type(in_) is StringType:
